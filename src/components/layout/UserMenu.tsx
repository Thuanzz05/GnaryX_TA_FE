        ...
        <div className="absolute right-0 mt-2 w-56 rounded-xl border border-border bg-white shadow-xl dark:border-border-dark dark:bg-surface-card-dark z-50">
          ...
          <div className="py-2">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2.5 text-black hover:bg-error-50 dark:text-white dark:hover:bg-slate-800 transition-colors font-medium"
            >
