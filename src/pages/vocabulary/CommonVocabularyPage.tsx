  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <div className="space-y-4">
        {visibleWords.map((word) => <VocabularyListItem key={`${word.id}-${word.isFavorite}`} word={word} onFavoriteToggle={toggleFavorite} scrollStorageKey="common-vocabulary-scroll" returnPath="/vocabulary/common-1000" />)}
      </div>
